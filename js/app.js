(() => {
    ...
    const values = document.querySelectorAll(".values-slide03__value");
    const lines = document.querySelectorAll(".values-slide03__line span");
    lines[0].style.width = values[0].innerHTML;
    lines[1].style.width = values[1].innerHTML;
    isWebp();
    addLoadedClass();
    digitsCounter();
})();